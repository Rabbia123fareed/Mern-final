...
const createProducts = async (req, res) => {
    const { name,price,category, brand,rating,description,images,thumbnail } = req.body
    ...
    if (!name || !images) {
        ...
        try {
            ...
            if (checkExisting) {
                ...
                await Product.create({ name,price,category, brand,rating,description,thumbnail,images })
