...
export default function Products() {
    ...
    axios.get('/api/getallproduct').then(json=> setProduct(json.data.products))
    return (
        <div className="container">
            <div className="d-flex justify-content-between align-items-center bg-danger p-3 mb-4 rounded">
